...
class TestServiceProviders:
    ...
    def test_get_phone_number_sms_processor(self) -> None:
        ...
        # Act
        processor = get_phone_number_sms_processor()

        # Assert
        assert isinstance(processor, DirectPhoneNumberSmsProcessor)
    ...
    def test_get_recipient_identifier_sms_processor(self) -> None:
        ...
        # Act
        processor = get_recipient_identifier_sms_processor()

        # Assert
        assert isinstance(processor, DirectRecipientIdentifierSmsProcessor)
