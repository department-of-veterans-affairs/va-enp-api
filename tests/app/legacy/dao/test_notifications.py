...
class TestLegacyNotificationDaoGet:
    ...
    async def test_get_non_existent_notification(self, uuid_factory: UUIDFactory) -> None:
    ...
    async def test_get_exception_handling(
        self, caught_exception: Exception, raised_exception: type[Exception], uuid_factory: UUIDFactory
    ) -> None:
...
class TestLegacyNotificationDaoDeleteNotification:
    ...
    async def test_delete_non_existent_notification(self, uuid_factory: UUIDFactory) -> None:
